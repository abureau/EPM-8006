...
PROC IMPORT DATAFILE = "/workspaces/workspace/DonnŽes EPM-8006/fram1.csv"
    OUT = fram1
    REPLACE
    DBMS = CSV;
RUN;
...
/*Pour calculer le RERI a partir des sorties, je
...
PROC SURVEYSELECT DATA = fram1b
    ...
    SEED = 571895 /*Germe pour controler le hasard*/
    REP = 1000 /*Nombre d'echantillons bootstrap*/
    OUTHITS /*Option necessaire*/
...
%INCLUDE "C:\Users\Denis Talbot\Dropbox\Travail\Cours\EPM8006\Automne2022\Bootstrap\jackboot.sas";

%BOOT(DATA = fram1b, samples = 1000, stat = RERI);

/*L'appel a BOOTCI est tres long a executer*/
%BOOTCI(METHOD = PERCENTILE, stat = RERI);
/*-1.12312 -2.47775 -0.074907 */
%BOOTCI(METHOD = BCA, stat = RERI);
/*-1.12312 -2.40903 -0.025305 */
